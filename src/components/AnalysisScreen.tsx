    ...
    <div className="px-4 pt-6 pb-4 space-y-6 relative min-h-[calc(100vh-200px)]">
      ...
      <div className="grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-6">
        {[
          ...
          <div key={label} className="tamar-card text-center p-4 md:p-6">
            <Icon size={24} className={`mx-auto mb-2 ${color}`} strokeWidth={1.5} />
      ...
      <div className="grid md:grid-cols-2 gap-6 items-start">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="tamar-card h-full">
        ...
        <div className="tamar-card h-full">
          ...
          <div className="space-y-4">
            {triggerFoods.map((food, i) => (
              ...
              >
                ...
                <span className="text-sm text-foreground w-32 truncate">{food.name}</span>
